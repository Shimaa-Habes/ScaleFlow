...
// استيراد الصفحات الأربع الجديدة
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // ====================================================
          // 3. صورة الخلفية بشفافية خفيفة
          // ====================================================
          Positioned.fill(
            child: Opacity(
              opacity: 0.10, // شفافية ناعمة لا تؤثر على وضوح المحتوى
              child: Image.asset(
  ...
  Widget _buildMainRiskBanner(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white
              .withOpacity(0.92), // خلفية شبه شفافة لتتناسق مع الصورة
