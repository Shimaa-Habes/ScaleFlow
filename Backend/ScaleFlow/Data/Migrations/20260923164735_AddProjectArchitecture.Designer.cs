...
namespace ScaleFlow.Data.Migrations
{
    ...
    [Migration("20260923164735_AddProjectArchitecture")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScaleFlow.Models.ProjectArchitecture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExternalServices")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ProjectArchitectures");
                });
            ...
            modelBuilder.Entity("ScaleFlow.Models.ProjectArchitecture", b =>
                {
                    b.HasOne("ScaleFlow.Models.Project", "Project")
                        .WithOne("Architecture")
                        .HasForeignKey("ScaleFlow.Models.ProjectArchitecture", "ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
