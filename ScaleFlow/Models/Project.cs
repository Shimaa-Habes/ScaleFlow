...
public class Project : SoftDeletableEntity
{
    ...
    public ICollection<AiRun> AiRuns { get; set; } = new HashSet<AiRun>();
    public ICollection<ProjectHealthSnapshot> HealthSnapshots { get; set; } = new HashSet<ProjectHealthSnapshot>();
